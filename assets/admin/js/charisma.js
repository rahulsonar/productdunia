$(document).ready(function(){
	...
	{
		var themeCssPath = $('#themeCssPath').val();
		$('#bs-css').attr('href',themeCssPath+'css/bootstrap-'+theme_name+'.css');
	}
	...
	//$('#is-ajax').prop('checked',$.cookie('is-ajax')==='true' ? true : false); // Commented by chaitenya 
