...
(function ($) {
    ...
    $.widget('blueimpUI.fileupload', $.blueimp.fileupload, {
        ...
        _renderDownload: function (files) {
            ...
            tmpl.find('.mainImg button').button({
                text: false,
                icons: {primary: 'ui-icon-star'}
            });
            tmpl.find('.setMainImg button').button({
                text: false,
        ...
        _mainImgHandler: function (e) {
            e.preventDefault();
            var button = $(this);
            e.data.fileupload._trigger('set_mainImage', e, {
                context: button.closest('.template-download'),
                url: button.attr('data-url'),
                type: button.attr('data-type'),
                dataType: e.data.fileupload.options.dataType
        ...
        _initEventHandlers: function () {
            ...
            filesList.find('.mainImg button')
	            .live(
	                'click.' + this.options.namespace,
	                eventData,
	                this._mainImgHandler
	            );
            filesList.find('.setMainImg button')
	            .live(
	                'click.' + this.options.namespace,
	                eventData,
	                this._setMainImgHandler
	            );
        ...
        _initFileUploadButtonBar: function () {
            ...
            fileUploadButtonBar.find('.mainImg')
	            .button({icons: {primary: 'ui-icon-image'}})
	            .bind('click.' + ns, function (e) {
	                e.preventDefault();
	                filesList.find('.mainImg button').click();
	            });
	        fileUploadButtonBar.find('.setMainImg')
	            .button({icons: {primary: 'ui-icon-trash'}})
	            .bind('click.' + ns, function (e) {
	                e.preventDefault();
	                filesList.find('.setMainImg button').click();
	            });
        },
