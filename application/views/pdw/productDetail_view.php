...
<div id="main">
	...
	<div class="proddetailsleft">
		...
		<a href="<?php echo base_url().$this->config->item('productImgPath') . $product['productImg']?>" class="jqzoom" rel='gal1'  title="<?php echo $product['productName']?>" >
			<img src="<?php echo base_url().$this->config->item('productLargeImgPath') . $product['productImg']?>" alt="<?php echo $product['productName']?>"  />
		</a>
		</div>
			...
			<tr>
				...
				<td class="avilbox1">
					...
					<p class="bigt"><?php echo $storeProdStats[$product['productId']]['storeCnt']; ?> STORES</p>
                                        <a href="#anchor1"><p class="offer">*Offer available in <?php echo $StoreCountOfferValues; ?> stores</p></a>
				</td>
				<?php } ?>
				<td class="avilbox1">
					<p>Price Range:</p>
