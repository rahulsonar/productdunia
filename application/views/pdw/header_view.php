    ...
    <div class="topmenu">
        <div class="mainholder">
            <div class="left">
                ...
                ?>
                    <a href="#">My Wishlist <span class="badge"><?php echo count($wishlistProds); ?></span></a> | <a href="<?php echo site_url('customer/mybargain');?>">Product pinger <span class="badge">0</span></a> | <a href="<?php echo site_url('customer/bargainRequest');?>">Store Pinger <span class="badge">0</span></a>
                <?php } else { ?>
